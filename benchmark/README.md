...
| 切分 | 年份 | 题数（可评分） | 用途 |
|---|---|---|---|
| train | 2010–2013/2017/2018/2020 | 165（95） | 分布先验、规则调参、污染探针语料 |
...
- 已知缺口：2017 无官方键（unscored）；2020 官方键未获；2014 有题无键（答案只发过已消亡的协会论坛）；2015/2016 题与键均随论坛消亡（Wayback 无快照）；2019 有题（官方 PNG）但答案从未以可读形式公布。2012/2013 已于 2026-07 补全入库（题+官方答案公报，逐字比对官网存档页）
